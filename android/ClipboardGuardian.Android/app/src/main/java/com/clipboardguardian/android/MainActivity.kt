...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Поле для ручного тестирования: пользователь сам копирует/вставляет стандартными действиями (меню/клавиатура).
    }
    ...
    private fun startProtection() {
        try {
            ...
            // Missing required manifest permissions (например FOREGROUND_SERVICE_*).
        } catch (_: IllegalStateException) {
            // Android может запретить старт FGS в некоторых состояниях.
        }
        applyUiState(true)
    }
