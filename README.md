...
4) При попытке вставить из буфера обмена через Ctrl+V или Shift+Insert будет запрашиваться разрешение.  
5) Доступ к буферу обмена будет блокироваться/разрешаться по кнопкам.
